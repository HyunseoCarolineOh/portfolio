    ...
    >
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-background border-b">
          <div className="container mx-auto py-4 space-y-2 px-4 md:px-6">
            {navItems.map((item) => (
              <a
                key={item.href}
                href={item.href}
              ...
              <Card>
                <CardHeader className="bg-muted/50">
                  <div className="flex flex-col gap-2">
                    <CardTitle className="text-2xl">{language === "en" ? "Hongik University" : "홍익대학교"}</CardTitle>
                ...
                <CardContent className="p-6">
                  <p className="mb-6">{language === "en" ? "5 Semester Scholarship Recipient" : "5학기 장학금 수혜"}</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Card className="overflow-hidden flex flex-col h-full">
                ...
                <CardHeader className="flex-grow">
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="flex items-center text-muted-foreground text-sm">
                      <Calendar className="mr-2 h-4 w-4" />
                      <span>{language === "en" ? "Aug 2024 - Nov 2024" : "2024년 8월 - 2024년 11월"}</span>
                    </div>
                  </div>
                </CardHeader>
                <CardContent className="flex-grow">
                  <p className="text-sm">
                    {language === "en"
                      ? "Improved weekly bookings by 1133% through iterative testing of solutions derived from customer funnel analysis in a space rental business."
                      : "공간대여 사업에서 데이터 기반 마케팅 실험을 통해 퍼널을 개선하고 매출을 1133% 증대시켰습니다."}
                  </p>
                </CardContent>
