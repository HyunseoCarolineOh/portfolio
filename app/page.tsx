      ...
      <main className="flex-1">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl/none">
                    {language === "en" ? (
                      "I identify problems through data and learn through action"
                    ) : (
              ...
              <Card>
                <CardHeader className="bg-muted/50">
                  <div className="flex flex-col gap-2">
                    <CardTitle className="text-2xl">홍익대학교</CardTitle>
                    <CardDescription className="text-lg">디자인학부 시각디자인전공</CardDescription>
                    <div className="flex items-center text-muted-foreground">
                      <Calendar className="mr-2 h-4 w-4" />
                      <span>2021년 3월 - 2026년 2월</span>
                    </div>
                  </div>
                </CardHeader>
                <CardContent className="p-6">
                  <p className="mb-6">5학기 장학금 수혜</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <Card className="relative overflow-hidden">
                <CardHeader className="py-6">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <CardTitle className="text-2xl mb-2">1위</CardTitle>
              ...
              <Card className="relative overflow-hidden">
                <CardHeader className="py-6">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <CardTitle className="text-2xl mb-2">3위</CardTitle>
                      <CardDescription className="text-lg font-medium text-foreground">창업 페스티벌</CardDescription>
                      <CardDescription className="text-muted-foreground mt-1">홍익대학교, 2023</CardDescription>
                    </div>
                  </div>
                </CardHeader>
              </Card>
        ...
        <section id="skills" className="py-12 md:py-16 lg:py-24">
          <div className="container px-4 md:px-6">
                ...
                <Card className="flex-grow">
                  <CardContent className="p-4 h-full flex flex-col justify-start">
                    <div className="flex items-center">
                      <div className="h-1.5 w-1.5 rounded-full bg-primary mr-3 flex-shrink-0 mt-1" />
                      <span className="text-sm">AI 챗봇 기획/개발</span>
                    </div>
                  </CardContent>
                </Card>
              </div>
                ...
                <Card className="flex-grow">
                  <CardContent className="p-4 h-full flex flex-col justify-start">
                    <div className="space-y-3">
                      {["유저 페르소나", "유저 스토리", "유저 경험 모델링"].map((skill, idx) => (
                        <div key={idx} className="flex items-center">
                          <div className="h-1.5 w-1.5 rounded-full bg-primary mr-3 flex-shrink-0 mt-1" />
                          <span className="text-sm">{skill}</span>
                        </div>
            ...
            <div className="mt-12">
              <h2 className="text-2xl font-bold mb-6">사용할 수 있는 툴</h2>
            ...
            <div className="mt-12">
              <h2 className="text-2xl font-bold mb-6">언어</h2>

              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card>
                  <CardContent className="flex flex-col items-center p-6">
                    <h3 className="text-xl font-semibold mb-2">한국어</h3>
                    <Badge className="mb-2">모국어</Badge>
                    <p className="text-muted-foreground">원어민</p>
                  </CardContent>
                </Card>
                <Card>
                  <CardContent className="flex flex-col items-center p-6">
                    <h3 className="text-xl font-semibold mb-2">영어</h3>
                    <Badge className="mb-2">Duolingo 135</Badge>
                    <p className="text-muted-foreground">유창함</p>
                  </CardContent>
                </Card>
                <Card>
                  <CardContent className="flex flex-col items-center p-6">
                    <h3 className="text-xl font-semibold mb-2">일본어</h3>
                    <Badge className="mb-2">JLPT N2</Badge>
                    <p className="text-muted-foreground">일상 대화</p>
                  </CardContent>
                </Card>
              </div>
            </div>
